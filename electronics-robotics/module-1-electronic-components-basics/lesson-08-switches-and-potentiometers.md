# Lesson 8: Switches and Potentiometers -- Twist, Click, Control
...
In **Lesson 9**, we add **sound** to our toolkit with buzzers. You will build a door alarm and use your Magic Measurement Wand to explore the difference between connected and disconnected circuits using continuity mode!
...
| | |
|:---|---:|
| [← Lesson 7: Transistors](lesson-07-transistors.md) | [Lesson 9: Buzzers and Sound →](lesson-09-buzzers-and-sound.md) |
