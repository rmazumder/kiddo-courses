# Lesson 6: Diodes and LEDs -- One-Way Streets and Rainbow Lights
...
In **Lesson 7**, we meet the **transistor** -- the most important electronic component ever invented. It is an electronic switch that can be controlled by electricity itself. Without transistors, computers, phones, and robots would not exist!
...
| | |
|:---|---:|
| [← Lesson 5: Capacitors](lesson-05-capacitors.md) | [Lesson 7: Transistors →](lesson-07-transistors.md) |
