# Lesson 4: Capacitors -- The Tiny Energy Tanks
...
In **Lesson 5**, we explore **diodes and LEDs** -- components that only let electricity flow ONE direction. You will build a rainbow of lights and use your Magic Measurement Wand to discover that each color uses a different amount of voltage!
