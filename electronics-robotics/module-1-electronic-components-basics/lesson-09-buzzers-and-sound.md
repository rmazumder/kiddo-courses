# Lesson 9: Buzzers and Sound -- Make Some Noise!
...
In **Lesson 10** -- the FINAL lesson of Module 1 -- you put EVERYTHING together and build a **Quiz Board game** where correct answers light up an LED and your Magic Measurement Wand helps you debug any problems. It is a real, working game you can play with friends and family!
...
| | |
|:---|---:|
| [← Lesson 8: Switches and Potentiometers](lesson-08-switches-and-potentiometers.md) | [Lesson 10: Project Quiz Board →](lesson-10-project-quiz-board.md) |
